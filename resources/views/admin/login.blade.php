                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="px-4 py-5 auth-form-wrapper">
                                        <a href="#"
                                            class="mb-2 noble-ui-logo logo-light d-block">Horizon<span>Heights</span></a>
                                        <h5 class="mb-4 text-muted fw-normal">Welcome back! Log in to your account.</h5>
                                        <form method="POST" action="{{ route('login') }}">
                                            @csrf
                                            <div class="mb-3">
                                                <label for="email" class="form-label" :value="__('Email')">Email
                                                    address</label>
                                            ...
                                            <div>
                                                <button type="submit"
                                                    class="mb-2 btn btn-outline-primary btn-icon-text mb-md-0">Login</button>

                                            </div>
                                            <a href="register.html" class="mt-3 d-block text-muted">Not a user? Sign
                                                up</a>
                                        </form>
                                    </div>
                                </div>
