                     ...
                     <div class="p-1 row g-0">
                         <div class="text-center col-3">
                             <a href="pages/apps/chat.html"
                                 class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i
                                     data-feather="message-square" class="mb-1 icon-lg"></i>
                         ...
                         <div class="text-center col-3">
                             <a href="pages/apps/calendar.html"
                                 class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i
                                     data-feather="calendar" class="mb-1 icon-lg"></i>
                         ...
                         <div class="text-center col-3">
                             <a href="pages/email/inbox.html"
                                 class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i
                                     data-feather="mail" class="mb-1 icon-lg"></i>
                         ...
                         <div class="text-center col-3">
                             <a href="{{ route('admin.profile') }}"
                                 class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i
                                     data-feather="instagram" class="mb-1 icon-lg"></i>
